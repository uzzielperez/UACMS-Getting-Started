...
// Sat Sep  5 11:55:13 2020 by ROOT version 6.12/07
// from TChain demo/fTree/
//////////////////////////////////////////////////////////

#ifndef FirstAnalysis_h
#define FirstAnalysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   FirstAnalysis(TTree *tree=0);
   virtual ~FirstAnalysis();
...
#ifdef FirstAnalysis_cxx
FirstAnalysis::FirstAnalysis(TTree *tree) : fChain(0) 
{
...
Int_t FirstAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FirstAnalysis::LoadTree(Long64_t entry)
{
...
void FirstAnalysis::Init(TTree *tree)
{
...
void FirstAnalysis::Show(Long64_t entry)
{
...
Int_t FirstAnalysis::Cut(Long64_t entry)
{
